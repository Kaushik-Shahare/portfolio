      ...
      <div className="bg-black bg-opacity-80 border border-green-400 rounded-lg p-8 hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-green-400/20 flex flex-col lg:flex-row items-center justify-center gap-8 w-full max-w-6xl">
        ...
        <div className="text-base text-center lg:text-left max-w-lg text-green-200 mt-6 lg:mt-0">
          ...
          <p className="mb-6">
            ...
            real-world problems. My technical toolkit includes{" "}
            <strong className="text-green-400">Python</strong>,{" "}
            <strong className="text-green-400">Django</strong>,{" "}
            <strong className="text-green-400">Flask</strong>, and{" "}
            <strong className="text-green-400">
              Artificial Intelligence and Machine Learning
            </strong>
            . I'm a lifelong learner who enjoys diving into new frameworks,
            participating in hackathons, and contributing to{" "}
            <strong className="text-green-400">open-source projects</strong> to
            stay aligned with industry trends and innovations.
          </p>
