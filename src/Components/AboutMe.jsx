...
const AboutMe = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      <h1 className="text-5xl font-bold mb-6 text-green-400 glitch-text pt-20 pb-10">
        About Me
      </h1>
      <div className="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-6xl">
        {/* Profile Image */}
        <div className="w-[60vh] h-[60vh] overflow-hidden border-4 border-green-400 shadow-lg flex-shrink-0">
          <img
            src="/Profile.jpeg"
            alt="Profile"
        ...
        {/* Text Content */}
        <div className="text-xl text-center lg:text-left max-w-lg text-gray-300">
          <p className="mb-8">
          ...
          <div className="mt-6 flex flex-col lg:flex-row lg:justify-start space-y-4 lg:space-y-0 lg:space-x-4">
            <a
              href="https://linkedin.com/in/kaushik-shahare-84bba7267" // Updated to correct LinkedIn profile
              className="text-green-400 hover:text-green-300 transition-colors duration-300"
            >
              LinkedIn
            </a>
            <a
              href="https://github.com/Kaushik-Shahare" // Updated to correct GitHub profile
              className="text-green-400 hover:text-green-300 transition-colors duration-300"
            >
              GitHub
            </a>
