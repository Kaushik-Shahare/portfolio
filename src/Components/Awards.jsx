      ...
      <div className="max-w-6xl mx-auto pt-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-green-300 text-base max-w-2xl mx-auto">
            Recognition and certifications that showcase my dedication to
            continuous learning and excellence in development.
          </p>
        </div>
          ...
          {awards.map((award, index) => (
            ...
            >
              ...
              <div className="text-center mb-4">
                ...
                <p className="text-green-400 text-sm mb-3">{award.date}</p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-green-300 mb-4">
                From beating 800+ participants in DSA competitions to leading
                teams in 36-hour hackathons, I consistently deliver excellence
                under pressure. As a team leader in the OnMySite HealthCare
                Hackathon, I successfully coordinated cross-functional
                development, managed project timelines, and guided technical
                decisions that led our team CodeBlue to a podium finish. My
                achievements reflect not just technical expertise, but proven
                leadership, strategic thinking, and the ability to transform
                complex challenges into winning solutions.
              </p>
